...
<body>
	...
	<header class="header-section">
		...
		<nav class="header-nav">
			...
			<div class="header-right">
				...
				<a href="views/member/register.jsp" class="hr-btn hr-btn-2">회원가입</a>
			</div>
	...
	<!-- CTA Section end -->
	<section class="cta-section set-bg" data-setbg="resources/img/cta-bg.jpg">
		<div class="container">
	...
	<section class="info-section spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
					<img src="resources/img/info-img.jpg" alt="">
				</div>
				<div class="col-lg-7">
					<div class="info-text">
	...
	<!-- Score Section end -->
	<section class="score-section text-white set-bg" data-setbg="resources/img/score-bg.jpg">
		<div class="container">
			<div class="row">
			...
			<img src="resources/img/hand.png" alt="" class="hand-img">
		</div>
	</section>
	<!-- Score Section end -->
