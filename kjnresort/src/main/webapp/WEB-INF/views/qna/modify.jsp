...
<input id="title" name="title" type="text" maxlength="2000" value="${qna.title }" style="width:500px; height: 35px;"><br>
<textarea id="content" name="content" rows="10" maxlength="2000" style="margin-top:20px; width:620px; height:580px;" >${qna.content }</textarea><br>
<div><button class="btn btn-default" id="cancelBtn">취소</button><button class="btn btn-primary" id="modiBtn">수정</button></div>
