...
public class RecruitController {
	...
	@PostMapping("/modify")
	public String modify(RecruitVO recruit, @ModelAttribute("cri") Criteria cri, RedirectAttributes rttr) {
	...
	public void get(@RequestParam("recruitNo") Long recruitNo, 
					Model model, 
	...
	public String register(RecruitVO recruit, RedirectAttributes rttr) {
		...
		rttr.addFlashAttribute("result", recruit.getRecruitNo());		// 등록된 게시글의 bno를 result값에 담아서 redirect로 넘겨준다.
